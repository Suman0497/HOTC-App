...
class VideosViewController: UIViewController {
    ...
    func getPhotosOfThumbnails(){
        func contentsOfDirectoryPath(path: String)-> [String]?{
            ...
            if newThumbImgs.contains("Bg.jpg"){
                newThumbImgs.remove(at: newThumbImgs.index(of: "Bg.jpg")!)
                
            }
            
            if newThumbImgs.contains("muhurtamBg.jpg"){
...
extension VideosViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if videoTitles.count == updatedThumbnails.count {
            ...
            if indexPath.row == 0{
                if updatedThumbnails != nil {
                    if updatedThumbnails.count == 6 {
                        cell.imgView.image = updatedThumbnails[0]
                    }else{
                        cell.imgView.image = UIImage(named: "haldiBg.jpg")!
                ...
                if updatedThumbnails != nil {
                    if updatedThumbnails.count == 6 {
                        cell.imgView.image = updatedThumbnails[1]
                    }else{
                        cell.imgView.image = UIImage(named: "mehendi2.jpg")!
                ...
                if updatedThumbnails != nil {
                              if updatedThumbnails.count == 6 {
                                  ...
                                  cell.imgView.image = updatedThumbnails[2]
                                  
                              }else {
                                  cell.imgView.image = UIImage(named: "muhurtamBg.jpg")!
                              }
                          }
                ...
                if updatedThumbnails != nil {
                    if updatedThumbnails.count == 6 {
                        cell.imgView.image  = updatedThumbnails[3]
                    }else{
                        cell.imgView.image = UIImage(named: "photo1.jpg") ?? UIImage(named: "photo1.jpg") as! UIImage
                ...
                if updatedThumbnails != nil {
                             if updatedThumbnails.count == 6 {
                                 ...
                                 cell.imgView.image = updatedThumbnails[4]
                                 
                             }else {
                                 cell.imgView.image = UIImage(named: "reception.jpg")!
                             }
                         }
                ...
                if updatedThumbnails != nil {
                    if updatedThumbnails.count == 6 {
                        ...
                        cell.imgView.image = updatedThumbnails[5]
                        
                    }else {
                        cell.imgView.image = UIImage(named: "sangBg.jpg") ?? UIImage(named: "sangeet.jpg") as! UIImage
                    }
                }
        ...
        case 0:
            ...
            if updatedThumbnails != nil {
                if updatedThumbnails.count == 6 {
                    ...
                    vc.bgImageBackground = UIImage(named: "haldiBg.jpg")!
        ...
        case 1:
            ...
            if updatedThumbnails != nil {
                if updatedThumbnails.count == 6 {
                    ...
                    vc.bgImageBackground = UIImage(named: "mehendiBg.jpg") ?? UIImage(named: "mehendi2.jpg") as! UIImage
                    
                }
            }else{
                vc.bgImageBackground = UIImage(named: "mehendiBg.jpg")!
        ...
        case 2:
            ...
            if updatedThumbnails != nil {
                if updatedThumbnails.count == 6 {
                    ...
                    vc.bgImageBackground = UIImage(named: "muhurtamBg.jpg")!
                }
            }
        ...
        case 3:
            ...
            if updatedThumbnails != nil {
                if updatedThumbnails.count == 6 {
                    ...
                    vc.bgImageBackground = UIImage(named: "photo1.jpg") ?? UIImage(named: "photo1.jpg") as! UIImage
        ...
        case 4:
            ...
            if updatedThumbnails != nil {
                if updatedThumbnails.count == 6 {
                    ...
                    vc.bgImageBackground = UIImage(named: "reception.jpg")!
                }
            }
        ...
        case 5:
            ...
            if updatedThumbnails != nil {
                if updatedThumbnails.count == 6 {
                    ...
                    vc.bgImageBackground = UIImage(named: "sangBg.jpg") ?? UIImage(named: "sangeet.jpg") as! UIImage
                }
            }
