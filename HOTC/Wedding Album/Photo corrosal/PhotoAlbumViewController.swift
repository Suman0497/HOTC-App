    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.albumImages.image = bgStr[indexPath.row]
                  ...
                  if indexPath.row == 0{
                      if bgStr != nil {
                          if bgStr.count == 6 {
                              cell.albumImages.image = bgStr[0]
                          }else{
                              cell.albumImages.image = UIImage(named: "haldiBg.jpg")!
                      ...
                      if bgStr != nil {
                          if bgStr.count == 6 {
                              cell.albumImages.image = bgStr[1]
                          }else{
                              cell.albumImages.image = UIImage(named: "mehendi2.jpg")!
                      ...
                      if bgStr != nil {
                                    if bgStr.count == 6 {
                                        ...
                                        cell.albumImages.image = bgStr[2]
                      ...
                      if bgStr != nil {
                          if bgStr.count == 6 {
                              cell.albumImages.image  = bgStr[3]
                          }else{
                              cell.albumImages.image = UIImage(named: "photo1.jpg") ?? UIImage(named: "photo1.jpg") as! UIImage
                      ...
                      if bgStr != nil {
                                   if bgStr.count == 6 {
                                       ...
                                       cell.albumImages.image = bgStr[4]
                                       
                                   }else {
                                       cell.albumImages.image = UIImage(named: "reception.jpg")!
                                   }
                               }
                      ...
                      if bgStr != nil {
                          if bgStr.count == 6 {
                              ...
                              cell.albumImages.image = bgStr[5]
                              
                          }else {
                              cell.albumImages.image = UIImage(named: "sangBg.jpg") ?? UIImage(named: "sangeet.jpg") as! UIImage
                          }
                      }
